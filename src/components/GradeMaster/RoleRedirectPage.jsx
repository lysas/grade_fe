...
// import ProfileSection from "./ProfileSection"; // Import ProfileSection
...
//         >
//           {options.map((option) => (
//             <div key={option} style={{ display: "flex", alignItems: "center", padding: "6px", borderBottom: "1px solid #eee" }}>
//               <input type="checkbox" id={option} checked={selectedValues.includes(option)} onChange={() => handleSelection(option)} style={{ marginRight: "10px" }} />
...
//         </div>
//         <MultiSelectDropdown className="role-redirect-multi-select-dropdown" label="Subjects" options={["All Subjects", "Maths", "Computer Science", "Biology", "Chemistry", "Physics", "English"]} selectedValues={selectedSubjects} onChange={setSelectedSubjects} />
//         <MultiSelectDropdown className="role-redirect-multi-select-dropdown" label="Boards" options={["CBSE", "ICSE", "State Board"]} selectedValues={selectedBoards} onChange={setSelectedBoards} />
//         <MultiSelectDropdown className="role-redirect-multi-select-dropdown" label="Languages" options={["English", "Hindi", "Tamil", "Malayalam", "Telugu"]} selectedValues={selectedLanguages} onChange={setSelectedLanguages} />
